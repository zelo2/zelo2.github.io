---
title: "Survey of Cognitive Diagnosis Models for Personalized Learning (面向个性化学习的认知诊断模型及其应用综述)"
...
citation: 'Hua Ma (马华), **Zhuoxuan Huang (黄卓轩)**, Wensheng Tang (唐文胜). "Survey of Cognitive Diagnosis Models for Personalized Learning (面向个性化学习的认知诊断模型及其应用综述)". <i>Computer Technology and Development</i> (计算机技术与发展), 2021.'
---

综述认知诊断模型及其在个性化学习场景中的应用。
